...
const ProjectPage = (props) => {
    ...
    let techBadges = {
        ...
        'css3': `<div class='my-2 col-lg-2 col-md-3 col-sm-5 col-6 hvr-bob'> <img class='skillIcon col-12' src="css3.png" alt="" /> <h3 class='text-center '>CSS 3</h3></div>`,
        ...
        'wordpress': `<div class='my-2 col-lg-2 col-md-3 col-sm-5 col-6 hvr-bob'> <img class='skillIcon col-12' src="wordpress.png" alt="" /> <h3 class='text-center '>WordPress</h3> </div>`,
