            ...
            <div id="skillsContainer" className='container py-5 mb-4'>
                ...
                <div className='my-4 bg-white px-4 py-4 rounded border shadow'>
                    ...
                    <div className='my-4 bg-light px-4 py-4 rounded border '>
                        ...
                        <button class="btn my-4 w-100 border-primary" type="button" data-toggle="collapse" data-target="#webdevSkills" aria-expanded="false" aria-controls="webdevSkills">
                            <h3 className='text-center my-2'>Web Development Skills</h3>
                        </button>
                        <i className="fa fa-carat-down"></i>



                        <div class="collapse" id="webdevSkills">
