            ...
            <div id="contactContainer" className='container col-12 col-xs-12 col-md-10 col-lg-10 col-xl-8 px-5 py-4 '>
                ...
                <div className='my-4 bg-white px-4 py-4 rounded border shadow'>
                    ...
                    <div className="d-flex row justify-content-center my-5">
                        ...
                        <a href='mailto:joshc@bluegeartechnology.com' target='blank' className='contactLink btn-outline-primary border-0 text-center btn mx-2 pt-4'>
                            <i className="fa fa-envelope fa-5x mx-auto"></i>
                            <h3 id='email' >joshc@bluegeartechnology.com</h3>
                        </a>

                        <a href='/resume' target='blank' className='contactLink btn-outline-success border-0 text-center btn mx-2 pt-4'>
                    ...
                    <div className="d-flex row justify-content-around my-5">
                        ...
                        <a href='https://github.com/bluegeartechnology' target='blank' className='contactLink text-center btn-outline-dark border-0 btn col-12 col-sm-6 col-md-4 col-lg-3'>
                            <i className="fa fa-github fa-5x mx-auto"></i>
                            <h3 id='github' className='text-center' >GitHub</h3>
                        </a>

                        <a href='https://linkedin.com/' target='blank' className='contactLink text-center btn-outline-primary border-0 btn col-12 col-sm-6 col-md-4 col-lg-3'>
                            <i className="fa fa-linkedin-square fa-5x mx-auto"></i>
                            <h3 id='youtube' >LinkedIn</h3>
                        </a>

                        <a href='https://youtube.com/' target='blank' className='contactLink text-center btn-outline-danger border-0 btn col-12 col-sm-6 col-md-4 col-lg-3'>
