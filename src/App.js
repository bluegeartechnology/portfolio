    ...
    <Router>
      <div className="App">
        ...
        <div id="footer" className='bg-light p-2 border border-light border-top-1'>
          <h6 className='text-dark m-0 text-center animate__animated animate__fadeInUp'>{`© ${new Date().getFullYear()} `}<span style={{ 'color': '#2080fb' }}>Blue</span>Gear <span style={{}}>Technology</span></h6>
        </div>
